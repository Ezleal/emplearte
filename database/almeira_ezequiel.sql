...
CREATE DATABASE IF NOT EXISTS `id20585116_test` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci */;
USE `id20585116_test`;
...
-- Volcando datos para la tabla id20585116_test.tipo_documento: ~3 rows (aproximadamente)
INSERT INTO `tipo_documento` (`id_tipo_documento`, `tipo_documento`) VALUES
	(1, 'DNI'),
	(2, 'LC'),
	(3, 'Pasaporte');

-- Volcando estructura para tabla id20585116_test.usuarios
...
-- Volcando estructura para tabla id20585116_test.empleados
...
-- Volcando datos para la tabla id20585116_test.empleados: ~4 rows (aproximadamente)
...
-- Volcando estructura para vista id20585116_test.empleados_detalle
...
-- Volcando datos para la tabla id20585116_test.usuarios: ~2 rows (aproximadamente)
...
FROM `id20585116_test`.`empleados` AS emp LEFT JOIN `id20585116_test`.`tipo_documento` AS td ON td.id_tipo_documento = emp.ID_TIPO_DOCUMENTO
LEFT JOIN `id20585116_test`.`provincia` AS pr ON pr.Id_Provincia = emp.ID_PROVINCIA WHERE emp.Activo = 'S' ;
